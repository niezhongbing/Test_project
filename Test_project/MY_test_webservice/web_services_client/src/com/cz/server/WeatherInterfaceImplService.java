 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceImplService", targetNamespace = "http://server.cz.com/", wsdlLocation = "http://127.0.0.1:12345/Weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACEIMPLSERVICE_QNAME = new QName("http://server.cz.com/", "WeatherInterfaceImplService");
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort() {
        return super.getPort(new QName("http://server.cz.com/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class);
    }
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.cz.com/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class, features);
    }
