...
<table class="layui-table" lay-data="{width:800, height:800, url:'json/table/demo2.json', page: true, limit: 6}">
  <thead>
    <tr>
      <th lay-data="{checkbox:true, fixed:'left'}" rowspan="2"></th>
      <th lay-data="{field:'username', width:80}" rowspan="2">联系人1</th>
...
<script src="/layerui_table/layer/layui.js" charset="utf-8"></script>
<script>
