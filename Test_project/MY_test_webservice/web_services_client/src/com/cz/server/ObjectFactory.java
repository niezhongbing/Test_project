 ...
 * generated in the com.cz.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.cz.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.cz.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cz.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cz.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cz.com/", name = "queryWeatherResponse")
